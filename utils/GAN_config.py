...
CONFIGS_ = {
    ...
    'cifar': ([16, 'M', 32, 'M', 'F'], 3, 10, 2048, 32),
    'cifar10': ([16, 'M', 32, 'M', 'F'], 3, 10, 2048, 32),
    ...
    'cifar100': ([32, 'M', 64, 'M', 128, 'F'], 3, 100, 2048, 128),
    ...
    'cifar10':
        {
            ...
            'ensemble_alpha': 1,  # teacher loss (server side)
            'ensemble_beta': 0,  # adversarial student loss
            'ensemble_eta': 0.3,  # diversity loss
            'unique_labels': 10,  # available labels
            'generative_alpha': 10,  # used to regulate user training
            'generative_beta': 10,  # used to regulate user training
            'weight_decay': 1e-2,
    ...
    'cifar100':
        {
            ...
            'ensemble_beta': 0,  # adversarial student loss
            'ensemble_eta': 0.3,  # diversity loss
            'unique_labels': 100,  # available labels
            'generative_alpha': 10,  # used to regulate user training
            'generative_beta': 10,  # used to regulate user training
            'weight_decay': 1e-2
        },
